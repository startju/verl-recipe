...
from recipe.partial_rollout.agent_loop.agent_loop import PRv3AgentLoopManager
...
class PRv3RayPPOTrainer(SeparateRayPPOTrainer):
    ...
    def init_workers(self):
        from recipe.partial_rollout.llm_server import PRv3LLMServerManager
        ...
        # PRv3LLMServerManager we replace the symbol on the upstream module for
        ...
        upstream_ray_trainer.LLMServerManager = PRv3LLMServerManager
        try:
